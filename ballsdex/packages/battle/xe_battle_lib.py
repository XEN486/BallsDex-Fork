...
def gen_battle(battle: BattleInstance):
    # run until all of the balls of another team have died
    while any(ball for ball in battle.p1_balls if not ball.dead) and any(ball for ball in battle.p2_balls if not ball.dead):
