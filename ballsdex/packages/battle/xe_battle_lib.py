...
def attack(current_ball, enemy_balls):
    ...
    attack_dealt = int(current_ball.attack * random.uniform(0.5, 1.25))
...
if __name__ == '__main__':
    battle = BattleInstance(
        [BattleBall("Republic of China", "eggum", 3120, 567), BattleBall("German Empire", "eggum", 2964, 784), BattleBall("United States", "eggum", 2850, 1309)],
        [BattleBall("United Kingdom", "xen64", 2875, 763), BattleBall("Israel", "xen64", 1961, 737), BattleBall("Soviet Union", "xen64", 2525, 864)]
    )
